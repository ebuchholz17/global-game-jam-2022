...
void addSprite (sprite s, game_assets *assets, char *textureKey, sprite_list *spriteList) {
    assert(spriteList->numSprites < MAX_SPRITES_PER_FRAME);
    sprite *nextSprite = &spriteList->sprites[spriteList->numSprites];
    ++spriteList->numSprites;
...
void addSprite (sprite s, game_assets *assets, char *atlasKey, char *frameName, sprite_list *spriteList) {
    assert(spriteList->numSprites < MAX_SPRITES_PER_FRAME);
    sprite *nextSprite = &spriteList->sprites[spriteList->numSprites];
    ++spriteList->numSprites;
